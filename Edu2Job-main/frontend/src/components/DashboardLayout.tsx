...
import { 
  ...
  LogOut, Bell, Users, Database, Briefcase, MessageSquare
} from "lucide-react";
      ...
      <aside className="sidebar">
        ...
        <nav className="sidebar-menu">
          {isAdmin ? (
            ...
            /* --- STUDENT MENU --- */
            <>
              <div style={{ padding: '0 16px', fontSize: '0.75rem', color: 'rgba(255, 255, 255, 0.5)', textTransform: 'uppercase', marginBottom: '8px', fontWeight: 700 }}>
                Student Menu
              </div>
