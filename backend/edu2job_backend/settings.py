# Use SQLite for development (no MySQL setup needed)
# Uncomment below and comment SQLite section if you want to use MySQL
# import pymysql
...
# Using SQLite for easier development (no MySQL setup required)
DATABASES = {
    'default': {
...
# Uncomment below to use MySQL instead (requires MySQL setup)
# DATABASES = {
#     'default': {
